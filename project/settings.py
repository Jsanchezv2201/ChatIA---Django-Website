...
ALLOWED_HOSTS = [h.strip() for h in env_first('DJANGO_ALLOWED_HOSTS', default='juansv22.pythonanywhere.com,chatia-lime.vercel.app,chatia-eaa0og4ug-juans-projects-369d1492.vercel.app,localhost,127.0.0.1,[::1]').split(',') if h.strip()]
